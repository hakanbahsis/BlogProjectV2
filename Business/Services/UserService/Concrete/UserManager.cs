...
public class UserManager : IUserService
{
    ...
    public UserManager(IMapper mapper, IUnitOfWork unitOfWork, UserManager<AppUser> userManager, RoleManager<AppRole> roleManager, IHttpContextAccessor httpContextAccessor, SignInManager<AppUser> signInManager, IImageHelper imageHelper)
    {
        _mapper = mapper;
    ...
    private async Task<Guid> UploadImageForUser(UserProfileDto userProfileDto)
    {
        ...
        var imageUpload = await _imageHelper.UploadImageAsync($"{userProfileDto.FirstName}{userProfileDto.LastName}", userProfileDto.Photo, ImageType.User);
